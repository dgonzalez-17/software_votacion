...
crearUsuario(datos: Usuario): Observable<Usuario>{
  return this.http.post<Usuario>(environment.url_api_gateway +'/usuario', datos)
}

consultarUsuarios() : Observable<Usuario[]> {
  return this.http.get<Usuario[]>(environment.url_api_gateway +'/usuario')
}

eliminarUsuario(id:string){
  return this.http.delete<Usuario>(environment.url_api_gateway +'/usuario/'+id)
}

editarUsuario(id:string, usuario: Usuario){
  return this.http.put<Usuario>(environment.url_api_gateway +'/usuario/'+id, usuario)
}
